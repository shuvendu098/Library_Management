...
public class adminsupport {
    ...
    admin_frame.setLayout(new GridLayout(3, 3));
    admin_frame.setBounds(650, 300, 800, 340);
  ...
  public void addUser(){
    ...
    add_user_frame.setBounds(700,300,600,200);
...
public void viewUser(){
  ...
  try {
      ...
      viewUsersFrame.setBounds(700,300,500,300);
      viewUsersFrame.setVisible(true);
  } catch (Exception e1) {
      JOptionPane.showMessageDialog(null, "An error occurs in the database. Please contact developer.");
  }
}
...
public void addNewBook(){
    JFrame book_frame = new JFrame("Enter Book Details");
            JLabel l1, l2, l3, l4, l5, l6, l7,l8,l0;
            l0=new JLabel("book id",SwingConstants.CENTER);
            l0.setOpaque(true);
            ...
            book_id_tf.setBackground( Color.white);
            book_id_tf.setForeground(Color.blue);
            ...
            submit_btn.addActionListener(new ActionListener() {
                @Override
                public void actionPerformed(ActionEvent e) {
                    int book_id=Integer.parseInt(book_id_tf.getText());
                    ...
                    int book_page= Integer.parseInt(book_pages_tf.getText());
                    int book_count=Integer.parseInt(booksnumber_tf.getText());
                    Connection connection = connect();
                    try {
                        Statement stmt = connection.createStatement();
                        stmt.executeUpdate("INSERT INTO `books` (`bid`,`book_isbn`, `book_name`, `book_publisher`,`book_edition`, `book_genre`, `book_price`,`book_page`,`book_count`) VALUES('" +book_id+ "','" +book_isbn+ "','" +book_name+ "','" +book_publisher+ "','"+book_edition+"','"+book_genre+"','"+book_price+"','"+book_page+"','"+book_count+"')");
            ...
            book_frame.setBounds(700,300,600,300);
            book_frame.setLayout(new GridLayout(10, 2));
...
public void returnABook(){
    ...
    return_book_btn.addActionListener(new ActionListener(){
        ...
        public void actionPerformed(ActionEvent rb){
            ...
            try{
                Statement stmt=connection.createStatement();
                stmt.executeUpdate("INSERT INTO `returned_books`(`bid`,`uid`,`return_date`,`fine`) VALUES('"+bid+"','"+uid+"','"+date+"','"+fine+"')");
